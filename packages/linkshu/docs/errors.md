...
| `MintInUse`              | `mint`, `rowCount`                   | `Mints.removeKnownMint`: stored rows still name the mint.                                                                  | Remove the stored rows first; spending alone may retain them. See [mints.md](./mints.md).                                        |
