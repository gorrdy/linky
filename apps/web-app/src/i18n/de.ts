...
export const de = {
  ...
  recurringRunFailedToast:
    "Die wiederkehrende Zahlung ist fehlgeschlagen. Sie wird erneut versucht.",
  ...
  recurringMoreOptions: "Beginn und Ende",
  recurringFirstRunLabel: "Erste Zahlung",
  recurringEndLabel: "Wie viele Zahlungen",
  recurringEndForever: "Unbegrenzt",
  recurringEndLimited: "Begrenzen",
  recurringDecrease: "Weniger",
  recurringIncrease: "Mehr",
  recurringSummaryFirst: "Erste Zahlung {date}",
  recurringSummaryLast: "letzte {date}",
  recurringSave: "Wiederkehrende Zahlung einrichten",
  recurringInvalidForm:
    "Bitte Empfänger, Betrag und ein gültiges Intervall wählen.",
