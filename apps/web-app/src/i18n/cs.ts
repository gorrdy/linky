export const cs = {
  ...
  recurringMoreOptions: "Začátek a konec",
  recurringFirstRunLabel: "První platba",
  recurringEndLabel: "Kolik plateb",
  recurringEndForever: "Bez omezení",
  recurringEndLimited: "Omezit počet",
  recurringDecrease: "Méně",
  recurringIncrease: "Více",
  recurringSummaryFirst: "První platba {date}",
  recurringSummaryLast: "poslední {date}",
  recurringSave: "Nastavit pravidelnou platbu",
  recurringInvalidForm: "Vyberte příjemce, částku a platný interval.",
