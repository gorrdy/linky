...
export const en = {
  ...
  recurringPaymentChatNote: "Recurring payment",
  recurringNotifyBody:
  ...
  recurringMoreOptions: "Start and end",
  recurringFirstRunLabel: "First payment",
  recurringEndLabel: "How many payments",
  recurringEndForever: "No limit",
  recurringEndLimited: "Limit",
  recurringDecrease: "Fewer",
  recurringIncrease: "More",
  recurringSummaryFirst: "First payment {date}",
  recurringSummaryLast: "last {date}",
  recurringSave: "Set up recurring payment",
  recurringInvalidForm: "Choose a recipient, an amount, and a valid interval.",
  ...
  recurringSkipNext: "Skip the next payment",
  recurringNotFound: "Recurring payment not found.",
  recurringOnlyWhileOpen:
    "Any of your devices with Linky open sends the payment. You are notified five minutes ahead and can cancel it.",
