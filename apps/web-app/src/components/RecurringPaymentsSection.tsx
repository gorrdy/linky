...
/** Recurring payments listed above the transaction history. */
export const RecurringPaymentsSection: FC = () => {
  ...
  return (
    <section
      ...
      aria-label={t("recurringPaymentsTitle")}
    >
      <h3 className="recurring-section-title">{t("recurringPaymentsTitle")}</h3>
